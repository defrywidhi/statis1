...
<!-- Toggler -->
<button class="mt-10 ml-3 inline-block rounded-full bg-white p-2 shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg" data-te-sidenav-toggle-ref data-te-target="#sidenav-1" aria-controls="#sidenav-1" aria-haspopup="true">
  <span class="block text-black">
      <i class="bi bi-chevron-right text-primary" style="font-size: 2rem;"></i>
  </span>
</button>