            ...
            <table id="myTable" class="table-auto pb-2 w-full bg-white shadow-lg rounded-lg border border-gray-300 ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="font-poppins border border-r-2 border-b-2 px-6 py-4 text-center ">{{ $dataSiswa['interval']}}</td>
                        <td class="font-poppins border border-r-2 border-b-2 px-6 py-4 text-center">{{ $dataSiswa['mid_value']}}</td>
                        <td class="font-poppins border border-r-2 border-b-2 px-6 py-4 text-center">{{ $dataSiswa['frequency']}}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
