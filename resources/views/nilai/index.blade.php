...
@section('content')
    ...
    <div class="mx-16">
        <div class="container mx-auto px-12">
            <h1 class=" text-5xl font-semibold mb-24 -mt-12 text-center text-white">DATA SKOR</h1>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class=" w-36 border border-r-2 border-b-2 px-6 py-4 text-center">
                            <a href="{{ route('nilai.edit', ['dataSiswa' => $dataSiswa]) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 rounded">Edit</a>
