...
<div class="container mx-auto px-12">
    ...
    <div class="mx-16">
        ...
        <div style="font-size: large" class=" text-white ml-16">
            ...
            <h1>Nilai Rata-rata: {{ $averageValueFormatted }}</h1> <!-- Menggunakan $averageValueFormatted yang telah diformat -->
        ...
        <div class="mx-16">
            <div class="container mx-auto width-3/5 px-12 mt-4 bg-white py-6 ">
                <table class="table-auto w-full bg-gray-100 rounded-lg border border-gray-300">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center px-6 py-3 border-b-2 border-r-2 border-gray-300">{{ $averageValueFormatted }}</td>
